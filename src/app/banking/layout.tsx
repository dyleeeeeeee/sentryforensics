        ...
        <div className="mx-3 mt-4 p-3 rounded-xl" style={{ background: "var(--glass-2)", border: "1px solid var(--glass-border)" }}>
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-white truncate">Alexander Chen</p>
              <p className="text-[10px] truncate" style={{ color: "var(--fg-tertiary)", fontFamily: "var(--font-mono)" }}>Case #SF-2024-0847</p>
            </div>
          </div>
